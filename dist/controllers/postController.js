...
// add a new post
exports.post_data = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { body } = req;
...
// delete a post
exports.delete_data = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
// edit a post
exports.patch_data = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id: _id } = req.params;
    const { body } = req;
    if (!req.userId)
...
// like a post
exports.like_data = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id: _id } = req.params;
    if (!req.userId)
        return res.json({ message: 'Unauthenticated user.' });
    try {
